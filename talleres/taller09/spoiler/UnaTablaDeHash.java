...
* @version 2
*/
//Nota: Hacen falta algunas partes de las lineas de codigo, estas estan indicadas con una linea, ¡debes completarlas! ademas esta estructura no maneja
...
public class UnaTablaDeHash
{
   ...
   */
   public int get(String k){
    return tabla.get( ___________ ).stream().filter(p -> p.name.equals(k)).collect(Collectors.toList()).get(0).__________;
